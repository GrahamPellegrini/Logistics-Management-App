package Shipment; // Package for handling shipments

import java.util.List;

import Shipment.Customer.Customer;
import Shipment.Packaging.PackagedProduct;
...
import java.time.LocalDateTime;
    ...
    public class Shipment {
        ...
        private LocalDateTime dispatchTime; // Time when shipment is dispatched
        private LocalDateTime estimatedDeliveryDateTime; // Expected delivery date and time
        ...
        public void dispatchShipment() {
            if(isDispatched){
                ...
                this.estimatedDeliveryDateTime = calculateEstimatedDeliveryTime();

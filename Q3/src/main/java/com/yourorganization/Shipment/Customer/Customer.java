...
public class Customer {
    ...
    public void setDistanceFromWarehouse(int distanceFromWarehouse) {
      ...
      public static Data.Customer convertToData(Customer customer) {
        return Data.Customer.newBuilder()
                .setId(customer.getId())
                .setName(customer.getName())
                .setDistanceFromWarehouse(customer.getDistanceFromWarehouse())
                .build();
    }

    public static Customer convertFromData(Data.Customer dataCustomer) {
        return new Customer(
            dataCustomer.getId(),
            dataCustomer.getName(),
            dataCustomer.getDistanceFromWarehouse()
        );
    }
}

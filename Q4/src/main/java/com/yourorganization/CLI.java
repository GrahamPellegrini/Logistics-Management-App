...
private void createShipment() {
    ...
    // Assuming you have a method to get transport by ID
    ...
    while (addingProducts) {
        ...
        Product product = stock.getProductById(productId); // Assuming this gets the product from StockCollection
        if (product == null) {
...
private void updateShipment() {
    ...
    // Assuming you have a method to get shipment by ID
